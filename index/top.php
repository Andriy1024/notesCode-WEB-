...
<header>
	<div class="header-top">
		...
		<div class="authorization">
			<ul>
				<li><a href="user.php"><?php echo $_SESSION['logged_user']->login; ?></a></li>
	...
	<div class="header-flex">
		<nav>
			<ul>
				...
				<li><a href="../c_plus_plus/victoryna.php">Tests</a></li>
				<li><a href="../c_plus_plus/index.php">C++</a></li>
